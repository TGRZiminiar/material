...
export const Landing: React.FC<LandingProps> = ({}) => {
    ...
    <div className="hero relative">
        <header className=" p-12 px-20 fixed w-full">
           <div className="flex justify-between">
           <a className='font-bold text-4xl text-[#094b65]'>Forest</a>
            <ul className="flex gap-12 font-bold text-base ">
                <li className="bg-[#094b65] p-2 px-4 rounded-[1.22rem] self-center text-white">Home</li>
                <li className=" self-center">About</li>
                <li className=" self-center">Destination</li>
                <li className=" self-center">Contact</li>
            </ul>
            </div>
        </header>

        <div className="absolute centerAbs">
            <h3 className="text-2xl text-center text-[#094b65] font-semibold">It's time for a new</h3>
            <h2 className="text-8xl text-[#094b65] font-bold">Adventure</h2>
        </div>
    </div>
    <div className="flex p-8 gap-4">
        {/* <div className=" relative w-[30vh] h-[40vh] border-2 bg-slate-800 text-white p-4 cardBg text-bold text-2xl">
            <button className="absolute centerAbs bg-indigo-400 hover:bg-indigo-700 p-2 px-3 rounded-full">
                <h2>Hover Me</h2>
            </button>
        </div> */}
    <div className="card relative w-[30vh] h-[40vh] border-2 bg-slate-800 text-white">
        <img src="https://static.vecteezy.com/system/resources/previews/001/849/553/original/modern-gold-background-free-vector.jpg" className="w-full h-full"/>
        {/* <button className="bg-indigo-400 hover:bg-indigo-700 p-2 px-3 rounded-full">
                <h2>Hover Me</h2>
            </button> */}
        <button className="slide bg-white w-[10vh] h-[10vh] absolute centerAbs">
                <h2 className="text-black   ">Hover Me</h2>
        </button>
        </div>

    <div className="card2 relative w-[30vh] h-[40vh] border-2 bg-slate-800 text-white">
        <img src="https://static.vecteezy.com/system/resources/previews/001/849/553/original/modern-gold-background-free-vector.jpg" className="w-full h-full"/>
        <button className="bg-white w-[10vh] h-[10vh] absolute centerAbs inner">
                <h2 className="text-black   ">Hover Me</h2>
        </button>
    </div>
    </div>
...
<body>
     <header id="header">
        <a href="#" className="logo">Forest</a>
        <ul>
